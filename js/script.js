(function($){
    ...
    $(function(){
        ...
        if($(window).width() < 992){
            $('.mbr-navbar--sticky').addClass('mbr-navbar--stuck').not('.mbr-navbar--open').addClass('mbr-navbar--short');
        }
        ...
        $(window).scroll(function(){
            $('.mbr-navbar--sticky').each(function(){
                var method = ($(window).scrollTop() > 10 || $(window).width() < 992) ? 'addClass' : 'removeClass';
                $('#banner')[method]('navbar-short');
